...
export default function Index() {
  return (
    <Main>
      <div className='flex flex-col-reverse items-center h-full justify-center leading-6 md:flex-row'>
        <div className=' w-full border-solid md:w-1/2'>
          ...
          <p className='pt-4 pb-8 m-0 leading-7 border-0 border-gray-300 sm:pr-10 lg:text-lg'>
            ...
            iste aliquid, culpa velit, accusamus totam expedita ad
            exercitationem dolor nobis.
          </p>
